...
type: concept
domains: [multimodal, applied-ai]
aliases: [vision-language system]
level: intermediate
relations:
...
Multimodal systems align and combine text, image, audio, or video representations so
...
critical when generated voice or likeness is involved.
...
- Prerequisites: [[contrastive-language-image-pretraining|Contrastive Language–Image Pretraining]], [[diffusion-model|Diffusion Models]]
- Used by: [[responsible-synthetic-personas|Responsible Synthetic Personas]]
